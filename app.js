...
function renderGaleria(items) {
  ...
  btn.addEventListener("click", () => {
    ...
    // Abrir la sección contacto automáticamente
    const contacto = document.getElementById("contacto");
    const toggleBtn = document.getElementById("toggleNote");
    if (contacto && toggleBtn) {
      contacto.classList.add("open"); // mostrar sección
      toggleBtn.textContent = "Ocultar proceso"; // actualizar texto del botón
    }

    // Scroll suave al botón "Ver proceso"
